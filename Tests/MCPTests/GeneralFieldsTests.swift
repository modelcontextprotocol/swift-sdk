...
struct GeneralFieldsTests {
  ...
  func testToolGeneralFields() throws {
    ...
    let metaObject = json?["_meta"] as? [String: Any]
    #expect(metaObject?["vendor.example/outputTemplate"] as? String == "ui://widget/kanban-board.html")
    ...
    #expect(decoded.general.additional["openai/toolInvocation/invoking"] == .string("Displaying the board"))
    #expect(
